const library = (() => {
  ...
  function onBorrowBook(id) {
    ...
    if (bookBorrowed[0] != undefined) {
      ...
      return `YOU HAVE SUCCESSFULLY BORROWED ${bookBorrowed[0]}`;
    } else {
...
const allBooks = library.allBooks;
const borrow = library.borrow;
const retrieve = library.retrieve;

module.exports = { allBooks, borrow, retrieve };
